                ...
                req.addEventListener("load", function() {{
                    if (this.status != 200 && this.response != 'OK') {{
                        ...
                        p.innerHTML +=
                            ...
                            'extension was not loaded. Please insert the ' +
                            'following into your ' +
                            '<a href="http://testnb.readthedocs.io/en/stable/config.html">' +
                            'notebook server configuration</a>:' +
                            '<pre>c.NotebookApp.nbserver_extensions = {{\n' +
                            '    \'nengo_gui.ipython\': True,\n' +
                            '}}</pre>';
